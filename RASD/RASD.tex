...
{ \LARGE \bfseries Requirements Analysis and Specifications Document (RASD)} \\[0.5cm]
{\large Version 1.5
}
\\[2cm] 
%\HRule \\[1.5cm]
...
\begin{itemize}
	...
	\item v 1.4
	\begin{itemize}
		\item UPDATE Alloy adding check fot the ``UNBOOK'' requirement.
		\item UPDATE use cases to highlight that users should be near the car in order to unlock it.
		\item ADD ``UNLK6`` under section 3.2: Functional Requirements
	\end{itemize}
