...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.88\textwidth]{UML/UI.png}
...
\begin{description}
	...
	\item[BILL/Calculate $\Leftrightarrow$ Sy/CalculatFee] \hfill
		\begin{description}[noitemsep]
	...
	\item[BILL/Pay $\Leftrightarrow$ Sy/MakePayment] \hfill
		...
		\end{description}
	\item[BILL/UnsafeParkingFine $\Leftrightarrow$ Sy/MakePayment] \hfill
		\begin{description}[noitemsep]
			\item[Responsability] Requires user to pay a fine for an unsafe parking.
			\item[Input] The ID of the user and the ID of the car unsafely parked.
			\item[Output] The fine is paid.
		\end{description}
	\end{description}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.88\textwidth]{UML/Components.png}
