...
\begin{itemize}[noitemsep]
	\item \textbf{SB/ALL/FunctionalityName} for shared functionalities
	\item \textbf{SB/CUST/FunctionalityName} for customer's reserved functionalities
	\item \textbf{SB/STAFF/FunctionalityName} for staff's reserved functionalities
\end{itemize}
